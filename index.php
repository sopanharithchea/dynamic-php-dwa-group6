      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12" data-aos="fade">
            <h1>Browse Jobs</h1>
            <a href="browse.php" class="btn btn-outline-success py-3 px-4">Click Here</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-8 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-md-12 text-center mt-5">
              <a href="browse.php" class="btn btn-primary rounded py-3 px-5"><span class="icon-plus-circle"></span> Show More Jobs</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 text-center" data-aos="fade">
            ...
            <p><a href="browse.php" class="btn btn-outline-warning py-3 px-4">Find Jobs</a></p>
