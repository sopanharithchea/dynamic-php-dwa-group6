            ...
            <div class="rounded border jobs-wrap">
              ...
              <a href="job-single.php" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
                ...
                <div class="job-details h-100">
                  <div class="p-3 align-self-center">
                    ...
                    <div class="d-block d-lg-flex">
                      <div class="mr-3"><span class="icon-suitcase mr-1"></span> <?php echo $result['company'];?></div>
                      <div class="mr-3"><span class="icon-room mr-1"></span> <?php echo $result['locationjob'];?></div>
                ...
                <div class="job-category align-self-center">
                  <div class="p-3">
                    <span class="text-info p-2 rounded border border-info"><?php echo $result['shift'];?></span>
                  </div>
                </div>  
              </a>
            </div>
